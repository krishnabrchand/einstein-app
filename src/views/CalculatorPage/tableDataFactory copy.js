...
// // const numberToCurrencyFormat = (value) => new Intl.NumberFormat("en-US", { maximumSignificantDigits: 3 }).format(value);
...
//       principal += rebuy;
//       totalAmount = (principal * Math.pow(1 + dailyInterestRate, 1)).toFixed(2); /** Principal + daily reward (10000 + 50 = 10050) */
...
//       rebuy=Math.floor(todayReward / 50) * 50; /** Today's rebuy amount if more than 50 */
//       dailyRewardsRunningBalance = todayReward + previousRemainingRewards; /** today's rewards + previous day left over rewards */
...
//       remaining_reward_After_Rebuy = Math.floor(remainingRewardsAfterRebuy / 50) * 50;
...
//        */
//       let totalPendingRewardsValue = principalThreeXRewards - totalRewards; /** Initial membership 3X - total rewards so far   */
